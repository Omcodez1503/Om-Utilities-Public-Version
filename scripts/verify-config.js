		...
		return new Promise((res) => {
			...
			client.login(config.token).then(async () => {
				...
				if(!client.guilds.cache.has("568120814776614924")){
					error("should be added to the emojis server", "please add your bot on this server: https://emojis.Om Utilities-bot.fr to make the emojis working");
				} else {
...
(async () => {
	...
	console.log(chalk.yellow("\n\nThank you for using Om Utilities. If you need more help, join our support server here: https://discord.Om Utilities-bot.fr"));
	process.exit(0);
})();
